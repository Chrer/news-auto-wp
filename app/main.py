...
app = FastAPI(title="News Auto WordPress Render API", version="20.0.0")
...
def root():
    ...
    return {
        ...
        "duplicate_protection": "url+title+slug+wordpress+in_run",
        "url_category_detection": True,
        "strict_category_feed_filter": True,
        "luz_noticias_special_extractor": True,
